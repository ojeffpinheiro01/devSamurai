<h1 align="center">Lista de convidados :bookmark_tabs:</h1>
...
Projeto de um website para controle de convidados de uma festa, onde o usuário pode adicionar e excluir convidados
